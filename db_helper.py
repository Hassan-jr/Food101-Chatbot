...
def get_all_food_items():
    try:
        cursor = cnx.cursor(dictionary=True)  # Use dictionary cursor to get results as dictionaries
        ...
        print(f"Error getting food items: {err}")
        return None
...
# Function to get all the orders items
...
# Function to get all order status
